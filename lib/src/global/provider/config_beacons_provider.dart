...
class ConfigBeaconsProvider extends ChangeNotifier {
  ...
  set idBeacons(String value){ _idBeacons = value; notifyListeners(); }

  Map<String,dynamic> _beaconsFirebase = {};
  Map<String,dynamic> get beaconsFirebase => _beaconsFirebase;
  set beaconsFirebase(Map<String,dynamic> value){ _beaconsFirebase = value; notifyListeners(); }
  ...
  Future initialData() async{
    ...
    try{
      ...
      List<QueryDocumentSnapshot> listData = await FirebaseConnectionConfigBeacons().getAllAffiliates();
  ...
  Future saveData({required BuildContext context, bool isConfig = false}) async {
    ...
    try{
      ...
      bool result = await FirebaseConnectionConfigBeacons().editAffiliate(
          data: data,
          id: idBeacons
      );
